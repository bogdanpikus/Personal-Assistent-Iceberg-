    ...
    <>
        ...
        <div id="NoteContainer" className="NoteClassContainer">
          {notes.map((note) => (
            <div
              ...
              className="note"
              id="noteOnTheWall"
              onClick={() => setSelectedText(note.text)}
            >
              <button
                id="closeNoteDivButton"
                onClick={(e) => {
                  e.stopPropagation();
                  deleteNoteFromTheWall(note.id);
                }}
              ></button>
      ...
      {showModal && (
        <>
          ...
          <div id="ModalAddNote">
            ...
            ></input>
            <textarea
              id="ModalAddNoteTextarea"
              placeholder="Whire some text..."
              ref={inputTextRef}
            ></textarea>
            <button
              type="button"
              id="ModalAddNoteCloseButton"
            ...
            <div id="remind">
              <p
                id="Reminder"
                title="Напоминание выскочит в то время, которое вы указали"
                ref={remindRef}
              >
                Reminder on/of:
              </p>
      ...
      {selectedText && (
        <div className="note-text-view" id="SelectedNoteTextBlock">
          ...
          <p>{selectedText}</p>
          <button
            id="SelectedNoteTextBlock_button"
