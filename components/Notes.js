...
const ModalAddNoteCloseButton = document.getElementById(
  "ModalAddNoteCloseButton",
);
...
const ModalAddNoteSubmitButton = document.getElementById(
  "ModalAddNoteSubmitButton",
);
...
AddNote.addEventListener("click", () => {
  WindowConteiner.style.display =
    WindowConteiner.style.display == "none" ||
    WindowConteiner.style.display == ""
      ? "flex"
      : "none";
  modalInput.value = "";
  WindowConteiner.setAttribute("tabindex", "-1"); // ������ ��� ������������
...
function renderNoteToWall(note) {
  ...
  if (activeWall) {
    ...
    if (NoteContainer.children.length == 12) {
      alert(
        "The limit of 12 notes has been reached.No new notes have been added.",
      );
      return;
    }
