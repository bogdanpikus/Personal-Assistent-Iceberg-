...
const input_progress_storage = document.getElementById(
  "input_progress_storage",
);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////// DONE!
const _1_2025 = new Date(currentYear, 0, 1); //������ ������ �� ���� 2025 1 ������
const lastNumberOfMonth = new Date(currentYear, 0 + 1, 0); // ������� ��������� ����� ������ (��� 31)
...
for (let amountMonth = 0; amountMonth < 12; amountMonth++) {
  let monthName = new Date(currentYear, amountMonth + 1, 0).toLocaleString(
    "en-GB",
    { month: "short" },
  );
